...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        ...
        #patched_resolution(224/4) = [56,56]
...
class SiTNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=96, kernel_size=3, reduction=4, bias=False, cab=True,
        ...
        self.patch_unembed1_1 = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=embed_dim, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)
        self.patch_unembed1_2 = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=embed_dim, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)
        self.patch_unembed1_3 = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=embed_dim, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)
        self.patch_unembed1_4 = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=embed_dim, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)

        self.patch_unembed2_1 = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=embed_dim, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)
        self.patch_unembed2_2 = PatchUnEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=embed_dim, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)
    ...
    def forward(self, x3_img):
        ...
        x1ltop = self.patch_unembed1_1(x1ltop, x1ltop_size)
        # [2, 96, 128, 128]
        ...
        x1rtop = self.patch_unembed1_2(x1rtop, x1rtop_size)
        ...
        x1lbot = self.patch_unembed1_3(x1lbot, x1lbot_size)
        # [2, 3, 128, 128]
        ...
        x1rbot = self.patch_unembed1_4(x1rbot, x1rbot_size)
        # [2, 96, 128, 128]
        ...
        x2top_cat = self.patch_unembed2_1(x2top_cat, x2top_size)
        ...
        x2bot_cat = self.patch_unembed2_2(x2bot_cat, x2bot_size)
